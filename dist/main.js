...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_dom_manipulation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dom_manipulation.js */ \"./src/modules/dom_manipulation.js\");\n\r\n\r\n\r\nconst refreshBtn = document.querySelector('#refresh');\r\nconst submitBtn = document.querySelector('#submit');\r\n\r\n(0,_modules_dom_manipulation_js__WEBPACK_IMPORTED_MODULE_1__.displayScores)();\r\n\r\nrefreshBtn.addEventListener('click', _modules_dom_manipulation_js__WEBPACK_IMPORTED_MODULE_1__.displayScores);\r\nsubmitBtn.addEventListener('click', (e) => {\r\n  e.preventDefault();\r\n  (0,_modules_dom_manipulation_js__WEBPACK_IMPORTED_MODULE_1__.addScore)();\r\n});\r\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");

/***/ }),

/***/ "./src/modules/api_request.js":
/*!************************************!*\
  !*** ./src/modules/api_request.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getScores\": () => (/* binding */ getScores),\n/* harmony export */   \"postScore\": () => (/* binding */ postScore)\n/* harmony export */ });\nconst url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/w5H6szVjLJnxg4RoIDTw/scores/';\n\nconst getScores = async () => {\n  const { result } = await fetch(url).then((response) => response.json());\n  return result;\n};\n\nconst postScore = async (user, score) => {\n  const data = { user, score };\n  const result = await fetch(url, {\n    method: 'POST',\n    headers: {\n      'Content-Type': 'application/json',\n    },\n    body: JSON.stringify(data),\n  })\n    .then((response) => response.json());\n  return result;\n};\n\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/api_request.js?");
